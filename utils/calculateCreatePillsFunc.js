...
const { getCreatePrompt, getTranslatePrompt, getCreateQuickPostPrompt, getRegeneratePrompt } = require("./generatePrompts")
...
const calculateRegeneratePillsFunc =  (req,res)=>{
    let {  platform, post} = req.body
    let num_posts = 1
        
        //avg tone length is taken as 7
    let prompt = getRegeneratePrompt(req,res)
    //openai cost per char
